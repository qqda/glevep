...
Die beiden Parameter \code{offset} und \code{uri}, innerhalb des \code{meta}-Objektes, sind von Kafka generiert und dienen der Wiederaufnahme eines abgebrochenen Streams.
